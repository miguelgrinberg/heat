...
class HeatWaitConditionHandle(wc_base.BaseWaitConditionHandle):
    ...
    attributes_schema = {
        ...
        SIGNAL: attributes.Schema(
            _('JSON map that includes the endpoint, token and/or other '
              'attributes the client must use for signalling this handle. '
              'The contents of this map depends on the type of signal '
